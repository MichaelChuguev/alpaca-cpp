...
struct PortfolioSnapshot {
    ...
    Decimal equity;
    Decimal profit_loss;
    Decimal profit_loss_pct;

    PortfolioSnapshot(const json& j)
    :
        timestamp(DateTime::parse(j["timestamp"])),
        equity(Decimal(j["equity"].get<double>())),
        profit_loss(Decimal(j["profit_loss"].get<double>())),
        profit_loss_pct(Decimal(j["profit_loss_pct"].get<double>()))
    {
    }
    ...
    json to_json() const {
        ...
        j["profit_loss"] = profit_loss.to_double();
        j["profit_loss_pct"] = profit_loss_pct.to_double();
        return j;
    }
...
struct PortfolioHistory {
    ...
    :
        base_value(Decimal(j["base_value"].get<double>())),
