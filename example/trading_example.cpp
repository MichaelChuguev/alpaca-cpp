...
int main() {
    ...
    try {
        ...
        limit_order.limit_price = 150.00;    // set limit price
        ...
        bracket_order.take_profit = {{"limit_price", 450.00}};  // Take profit above current price
        bracket_order.stop_loss = {{"stop_price", 400.00}};    // Stop loss below current price
