...
TEST(PositionTest, ParseFromJson) {
    ...
    EXPECT_DOUBLE_EQ(pos.avg_entry_price, 150.0);
    EXPECT_DOUBLE_EQ(pos.qty, 10.0);
    EXPECT_DOUBLE_EQ(pos.qty_available, 10.0);
    EXPECT_EQ(pos.side, OrderSide::BUY);
    EXPECT_DOUBLE_EQ(pos.market_value, 1550.0);
    EXPECT_DOUBLE_EQ(pos.cost_basis, 1500.0);
    EXPECT_DOUBLE_EQ(pos.unrealized_pl, 50.0);
    EXPECT_DOUBLE_EQ(pos.current_price, 155.0);
    EXPECT_DOUBLE_EQ(pos.lastday_price, 152.0);
