...
TEST(AccountTest, ParseFromJson) {
    ...
    EXPECT_DOUBLE_EQ(account.buying_power, 100000.00);
    EXPECT_DOUBLE_EQ(account.regt_buying_power, 100000.00);
    EXPECT_DOUBLE_EQ(account.daytrading_buying_power, 400000.00);
    EXPECT_DOUBLE_EQ(account.effective_buying_power, 100000.00);
    EXPECT_DOUBLE_EQ(account.non_marginable_buying_power, 50000.00);
    EXPECT_DOUBLE_EQ(account.options_buying_power, 100000.00);
    EXPECT_DOUBLE_EQ(account.bod_dtbp, 400000.00);
    EXPECT_DOUBLE_EQ(account.cash, 100000.00);
    EXPECT_DOUBLE_EQ(account.accrued_fees, 0.00);
    EXPECT_DOUBLE_EQ(account.portfolio_value, 100000.00);
    ...
    EXPECT_DOUBLE_EQ(account.equity, 100000.00);
    EXPECT_DOUBLE_EQ(account.last_equity, 99000.00);
    EXPECT_DOUBLE_EQ(account.long_market_value, 50000.00);
    EXPECT_DOUBLE_EQ(account.short_market_value, 0.00);
    EXPECT_DOUBLE_EQ(account.position_market_value, 50000.00);
    EXPECT_DOUBLE_EQ(account.initial_margin, 25000.00);
    EXPECT_DOUBLE_EQ(account.maintenance_margin, 12500.00);
    EXPECT_DOUBLE_EQ(account.last_maintenance_margin, 12000.00);
    EXPECT_DOUBLE_EQ(account.sma, 100000.00);
    EXPECT_EQ(account.daytrade_count, 0);
    EXPECT_DOUBLE_EQ(account.balance_asof, 100000.00);
