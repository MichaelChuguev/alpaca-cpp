...
TEST(CryptoWalletTest, ParseFromJson) {
    ...
    EXPECT_EQ(wallet.qty, Decimal(1.5));
    EXPECT_EQ(wallet.available_qty, Decimal(1.0));
    EXPECT_EQ(wallet.pending_qty, Decimal(0.3));
    EXPECT_EQ(wallet.locked_qty, Decimal(0.2));
}
...
TEST(CryptoWalletTest, ParseMissingFields) {
    ...
    EXPECT_EQ(wallet.qty, Decimal(0.0));
    EXPECT_EQ(wallet.available_qty, Decimal(0.0));
}
...
TEST(CryptoTransferTest, ParseFromJson) {
    ...
    EXPECT_EQ(transfer.amount, Decimal(0.5));
    EXPECT_EQ(transfer.network, "bitcoin");
    EXPECT_EQ(transfer.fees, Decimal(0.0001));
...
TEST(CryptoTransferTest, ParseMissingOptionalFields) {
    ...
    EXPECT_EQ(transfer.amount, Decimal(1.0));
...
TEST(CryptoTransferEstimateTest, ParseFromJson) {
    ...
    EXPECT_EQ(est.fee, Decimal(0.001));
